...
public enum ExecutionDependency {
  /**
   ...
   * implementations may choose to re-execute such nodes automatically whenever
   ...
   * parent node and so cannot be executed independently. If the parent node
   * invokes {@link ExecutionContext#executeChildren()} during its own
   * execution, this node will be executed at that time.
   */
  EXECUTION_STATE
}
