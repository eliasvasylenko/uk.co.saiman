...
import uk.co.saiman.instrument.stage.msapex.SamplePlateStylesheet;
 ...
 */
@Component
public class SamplePlateStylesheet implements Stylesheet {
	@Override
	...
	public URL getURL(Theme t) {
		return SamplePlateStylesheet.class.getClassLoader().getResource("css/sampleplate.css");
	}
}
