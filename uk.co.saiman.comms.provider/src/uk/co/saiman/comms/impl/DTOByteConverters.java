 ...
 * classes are introduced by Project Amber. Fields will almost certainly retain
 * ordering in the class file, so more sensible default bit-layouts will be
 * possible without throwing annotations around everywhere. It will also lend a
 * little more weight to the design choice of having plain data-carriers with
 * public fields by embedding the concept in the language.
 */
@Component
