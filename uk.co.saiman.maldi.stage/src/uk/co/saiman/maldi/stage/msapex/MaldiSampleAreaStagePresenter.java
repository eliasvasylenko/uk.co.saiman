...
public class MaldiSampleAreaStagePresenter implements ResourcePresenter<SamplePlateStage> {
  private final MaldiStageProperties properties;

  @Activate
  public MaldiSampleAreaStagePresenter(@Reference MaldiStageProperties properties) {
  ...
  public String getIconURI() {
    return "fugue:size16/target.png";
  }
