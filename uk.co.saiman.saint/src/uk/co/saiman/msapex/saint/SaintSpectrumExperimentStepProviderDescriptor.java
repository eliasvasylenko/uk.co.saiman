...
@Component
public class SaintSpectrumExperimentStepProviderDescriptor implements StepProviderDescriptor {
  public static final String ID = "uk.co.saiman.experiment.step.provider.spectrum.saint";

  private final SaintProperties properties;

  @Activate
  public SaintSpectrumExperimentStepProviderDescriptor(@Reference PropertyLoader properties) {
  ...
  public Class<? extends StepProvider<?>> getProviderClass() {
    return SaintSpectrumExperimentStepProvider.class;
  }
}
