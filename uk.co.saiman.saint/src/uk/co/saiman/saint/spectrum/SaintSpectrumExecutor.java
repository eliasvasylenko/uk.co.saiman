 ...
 */
package uk.co.saiman.saint.spectrum;
...
import uk.co.saiman.saint.spectrum.SaintSpectrumExecutor.SaintSpectrumExecutorConfiguration;
...
public class SaintSpectrumExecutor implements SpectrumExecutor {
  ...
  static final String CONFIGURATION_PID = "uk.co.saiman.saint.executor.spectrum";
