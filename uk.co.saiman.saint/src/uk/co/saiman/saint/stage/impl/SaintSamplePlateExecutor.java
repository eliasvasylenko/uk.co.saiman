...
import uk.co.saiman.saint.stage.SamplePlate;
import uk.co.saiman.saint.stage.SamplePlateStage;
import uk.co.saiman.saint.stage.SamplePlateSubmission;
import uk.co.saiman.saint.stage.SamplePreparation;
import uk.co.saiman.saint.stage.impl.SaintSamplePlateExecutor.SaintXYStageExecutorConfiguration;

@Designate(ocd = SaintXYStageExecutorConfiguration.class, factory = true)
@Component(configurationPid = SaintSamplePlateExecutor.CONFIGURATION_PID, configurationPolicy = REQUIRE, service = {
    SaintSamplePlateExecutor.class,
    Executor.class })
public class SaintSamplePlateExecutor implements Executor<Nothing> {
  ...
  @Activate
  public SaintSamplePlateExecutor(
