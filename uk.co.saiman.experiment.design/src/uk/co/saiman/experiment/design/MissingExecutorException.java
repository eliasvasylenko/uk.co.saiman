...
public class MissingExecutorException extends ExperimentStepDesignException {
  private static final long serialVersionUID = 1L;

  public MissingExecutorException(ExperimentPath<?> stepPath) {
    super("Executor is missing at step '" + stepPath + "'", stepPath);
  }
}
