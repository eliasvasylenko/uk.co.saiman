...
public class ExperimentDesignException extends RuntimeException {
  private static final long serialVersionUID = 1L;

  ExperimentDesignException(String message) {
    super(message);
  }

  ExperimentDesignException(String message, Throwable cause) {
    super(message, cause);
  }
}
