...
public class UnresolvedReferenceException extends ExperimentDesignException {
  private static final long serialVersionUID = 1L;

  private final ExperimentId sharedMethodId;

  public UnresolvedReferenceException(ExperimentId sharedMethodId) {
    super("Unable to resolve shared method id '" + sharedMethodId + "'");
