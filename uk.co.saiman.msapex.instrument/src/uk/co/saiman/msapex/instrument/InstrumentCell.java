...
@Component(name = InstrumentCell.ID, service = MCell.class)
public class InstrumentCell extends MCellImpl {
  ...
  @Reference(target = "(" + COMPONENT_NAME + "=" + DeviceCell.ID + ")")
  ...
  public static class Contribution {
    ...
    public void prepare(@Named(ENTRY_DATA) Instrument data, ListItems children) {
      children.addItems(DEVICES_ID, data.getDevices().collect(toList()));
    }
  }
}
