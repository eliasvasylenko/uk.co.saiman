...
import static uk.co.saiman.msapex.experiment.workspace.event.WorkspaceEventKind.CLOSE;
...
public class CloseExperimentEvent extends WorkspaceEvent {
  public CloseExperimentEvent(Workspace workspace, WorkspaceExperiment experiment) {
