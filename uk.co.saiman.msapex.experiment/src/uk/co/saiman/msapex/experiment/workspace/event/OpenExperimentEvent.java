...
import static uk.co.saiman.msapex.experiment.workspace.event.WorkspaceEventKind.OPEN;
...
public class OpenExperimentEvent extends WorkspaceEvent {
  public OpenExperimentEvent(Workspace workspace, WorkspaceExperiment experiment) {
