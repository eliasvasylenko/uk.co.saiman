...
public interface SamplePlate {
  SampleArea sampleArea(StateMap state);

  XYCoordinate<Length> lowerBound();

  XYCoordinate<Length> upperBound();

  StateMap persistSampleArea(SampleArea sampleArea);

  boolean containsSampleArea(SampleArea sampleArea);
}
