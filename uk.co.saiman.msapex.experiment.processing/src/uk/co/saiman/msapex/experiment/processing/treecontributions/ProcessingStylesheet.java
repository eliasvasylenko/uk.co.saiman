 ...
 */
@Component(property = Constants.SERVICE_RANKING + ":Integer=" + ProcessingStylesheet.RANKING)
public class ProcessingStylesheet implements Stylesheet {
	...
	public URL getURL(Theme t) {
		return ProcessingStylesheet.class.getClassLoader().getResource("css/processing.css");
	}
}
