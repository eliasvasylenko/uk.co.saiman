...
import uk.co.saiman.instrument.msapex.InstrumentStylesheet;
 ...
 */
@Component
public class InstrumentStylesheet implements Stylesheet {
	@Override
	...
	public URL getURL(Theme t) {
		return InstrumentStylesheet.class.getClassLoader().getResource("css/instrument.css");
	}
}
