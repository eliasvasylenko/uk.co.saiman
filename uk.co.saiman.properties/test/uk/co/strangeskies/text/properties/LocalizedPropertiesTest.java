...
public class LocalizedPropertiesTest {
  public LocalizerTestProperties text(LocaleManager manager) {
    return PropertyLoader.newPropertyLoader(manager).getProperties(LocalizerTestProperties.class);
  }
  ...
  public void localeChangeStringEventTest() {
    ...
    LocalizedString string = text(manager).simpleLocalized();
  ...
  public void localeChangeStringNoEventTest() {
    ...
    LocalizedString string = text(manager).anotherSimpleLocalized();
