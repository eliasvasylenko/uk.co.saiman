...
import uk.co.saiman.text.provider.LocaleManagerService.LocaleManagerConfiguration;
...
public class LocaleManagerService implements LocaleManager, LocaleProvider {
   ...
   */
  static final String CONFIGURATION_PID = "uk.co.saiman.text.locale.manager";
  /**
