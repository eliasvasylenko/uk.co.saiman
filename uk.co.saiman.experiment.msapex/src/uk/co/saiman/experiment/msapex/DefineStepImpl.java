...
public class DefineStepImpl implements DefineStep {
  private final Predicate<ExperimentId> validate;
  private final Executor executor;

  public DefineStepImpl(StepContainer<?, ?> target, Executor executor) {
    this(id -> target.findSubstep(id).isEmpty(), executor);
  }

  protected DefineStepImpl(Predicate<ExperimentId> validate, Executor executor) {
