...
import static uk.co.saiman.experiment.msapex.workspace.event.WorkspaceEventKind.REMOVE;
...
public class RemoveExperimentEvent extends WorkspaceEvent {
  public RemoveExperimentEvent(Workspace workspace, WorkspaceExperiment experiment) {
