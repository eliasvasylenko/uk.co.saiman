...
import static uk.co.saiman.experiment.msapex.workspace.event.WorkspaceEventKind.ADD;
...
public class AddExperimentEvent extends WorkspaceEvent {
  public AddExperimentEvent(Workspace workspace, WorkspaceExperiment experiment) {
