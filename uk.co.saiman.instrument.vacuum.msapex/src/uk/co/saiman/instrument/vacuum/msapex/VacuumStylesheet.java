...
/**
 * Default stylesheet for vacuum hardware view.
 * 
 * @author Elias N Vasylenko
 */
@Component
public class VacuumStylesheet implements Stylesheet {
	@Override
	...
	public URL getURL(Theme t) {
		return VacuumStylesheet.class.getClassLoader().getResource("css/vacuum.css");
	}
}
