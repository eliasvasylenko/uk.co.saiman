...
public interface WebModules {
  Optional<WebModule> getResource(String moduleName, Version moduleVersion);

  Stream<WebModule> getResources(String moduleName, VersionRange moduleVersion);

  Stream<Version> getVersions(String moduleName);
