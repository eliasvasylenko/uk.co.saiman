...
/*
 * TODO make into data class after introduction by Project Amber
 */
public final class Payload<T> {
  public final T data;
  public final Map<String, Object> ancillaryData;

  public Payload(T data, Map<String, Object> ancillaryData) {
    this.data = data;
    this.ancillaryData = unmodifiableMap(new HashMap<>(ancillaryData));
  }
