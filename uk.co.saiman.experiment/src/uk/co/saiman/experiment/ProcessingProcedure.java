...
public interface ProcessingProcedure<S, T, U> extends Procedure<S, U> {
  @Override
  ...
  @Override
  default U proceed(ProcedureContext<S, U> context) {
  ...
  default TypeToken<T> getInputType() {
    return forType(getThisType())
        .resolveSupertype(ProcessingProcedure.class)
