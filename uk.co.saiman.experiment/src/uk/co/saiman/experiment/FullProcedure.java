...
public class FullProcedure implements VoidExperimentProcedure<ExperimentConfiguration> {
  ...
  private static final FullProcedure INSTANCE = new FullProcedure();
  ...
  public static FullProcedure instance() {
    return INSTANCE;
  }
}
