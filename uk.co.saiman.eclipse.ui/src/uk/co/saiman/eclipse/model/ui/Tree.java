 ...
 * </p>
 * <ul>
 *   <li>{@link uk.co.saiman.eclipse.model.ui.Tree#isEditable <em>Editable</em>}</li>
 * </ul>
 *
 * @see uk.co.saiman.eclipse.model.ui.Package#getTree()
 * @model
 * @generated
 */
public interface Tree extends MContext, MContribution, MElementContainer<Cell> {
   ...
   * @see uk.co.saiman.eclipse.model.ui.Package#getTree_Editable()
   * @model
   * @generated
   */
  boolean isEditable();
  ...
  /**
   * Sets the value of the '{@link uk.co.saiman.eclipse.model.ui.Tree#isEditable <em>Editable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
