...
public class SaiUiModel {
  ...
  /**
   * The primary context key for a {@link MUIElement UI element}. If the primary
   * key is not present in the {@link MContext context} of a UI element then the
   * element may be {@link #NO_AUTO_HIDE automatically hidden} or
