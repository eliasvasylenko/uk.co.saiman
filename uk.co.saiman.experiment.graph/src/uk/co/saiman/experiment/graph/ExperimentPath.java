...
public abstract class ExperimentPath<T extends ExperimentPath<T>>
  ...
  public abstract Iterator<? extends ExperimentGraphEdge> iterator();
  ...
  public static class Absolute extends ExperimentPath<Absolute> {
    ...
    @Override
    public Iterator<? extends ExperimentGraphEdge> iterator() {
      return ids().map(ExperimentGraphEdge.Dependent::new).collect(toList()).iterator();
    }
  }
  ...
  public static class Relative extends ExperimentPath<Relative> {
    ...
    @Override
    public Iterator<ExperimentGraphEdge> iterator() {
      return Stream
          .concat(
              IntStream.range(0, ancestors).mapToObj(i -> new ExperimentGraphEdge.Dependency()),
              ids().map(ExperimentGraphEdge.Dependent::new))
          .collect(toList())
          .iterator();
    }
  }
