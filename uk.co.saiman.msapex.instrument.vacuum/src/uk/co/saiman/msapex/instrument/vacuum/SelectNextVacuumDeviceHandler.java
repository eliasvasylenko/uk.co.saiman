 ...
 */
public class SelectNextVacuumDeviceHandler {
  @Inject
  @Service
  List<VacuumDevice<?>> availableDevices;

  @Execute
  void execute(IEclipseContext context, @Optional VacuumDeviceSelection selectedDevices) {
    List<VacuumDevice<?>> availableDevices = new ArrayList<>(this.availableDevices);
    List<VacuumDevice<?>> selection = selectedDevices != null
    ...
    context
        .modify(
            ...
            new VacuumDeviceSelection(singleton(availableDevices.get(index))));
  }
}
