...
/**
 * A registration of a device. A device registration is obtained when a device
 * {@link Instrument#registerDevice(Device) registers} itself to an instrument.
 * It should be owned by the registered device, and typically should not be
 * exposed outside the implementation of the device.
 * <p>
...
public interface DeviceRegistration {
  ...
  /**
   * @return the corresponding instrument registration
   */
