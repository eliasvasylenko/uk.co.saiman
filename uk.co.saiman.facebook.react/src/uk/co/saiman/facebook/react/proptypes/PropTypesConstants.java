...
@ProvideCapability(
    ...
    version = PROP_TYPES_WEB_RESOURCE_VERSION,
    value = ("root=/META-INF/resources/webjars/prop-types/" + PROP_TYPES_WEB_RESOURCE_VERSION) + ";"
        + (WebResourceNamespace.NS + "=" + PROP_TYPES_WEB_RESOURCE_NAME))
public interface PropTypesConstants {
  final String PROP_TYPES_WEB_RESOURCE_NAME = "/facebook/prop-types";
  final String PROP_TYPES_WEB_RESOURCE_VERSION = "15.5.10";
}
