...
import uk.co.saiman.instrument.acquisition.msapex.AcquisitionStylesheet;
 ...
 */
@Component
public class AcquisitionStylesheet implements Stylesheet {
	@Override
	...
	public URL getURL(Theme t) {
		return AcquisitionStylesheet.class.getClassLoader().getResource("css/acquisition.css");
	}
}
