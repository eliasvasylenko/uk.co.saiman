 ...
 */
package uk.co.saiman.experiment.storage.service;
...
public interface StorageService {
  ...
  StorageConfiguration<?> configureStorage(StateMap persistedState);

  <T> StateMap deconfigureStorage(StorageConfiguration<T> processor);
}
