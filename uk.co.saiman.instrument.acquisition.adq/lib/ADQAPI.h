/*
 * (C)opyright 2008-2012 Signal Processing Devices Sweden AB
 */

#ifndef ADQAPI
#define ADQAPI
#define VALIDATE_DLL(p) if(!IS_VALID_DLL(p)) exit(-1);
#define IS_VALID_DLL(p) (p->ValidateDll() == 0x11AABEEF)
...
struct ADQInterface
{
  ...
  virtual unsigned int ReBootADQFromFlash() = 0;
  ...
  virtual unsigned int TriggeredStreamingSetupV5(unsigned int SamplePerRecord, unsigned int NofPreTrigSamples, unsigned int NofHoldOffSamples, unsigned int ArmMode, unsigned int ReadOutSpeed, unsigned int Channel) = 0;
  ...
  virtual unsigned int ResetRecorder() = 0;
  virtual unsigned int ResetFIFOPaths() = 0;
  virtual unsigned int RunRecorderSelfTest(unsigned int* inout_vector) = 0;
  virtual unsigned int GetRecorderStatus(unsigned int* status) = 0;
  virtual unsigned int GetRecorderDiskStatus(unsigned int diskno, unsigned int* status) = 0;
  virtual unsigned int BreakRecorderCommand() = 0;
  virtual unsigned int SendRecorderCommand(unsigned char cmd, unsigned int arg1, unsigned int arg2, unsigned int* answer) = 0;
  virtual unsigned int WriteDataToDSU(unsigned int start_address, unsigned int nofbytes, unsigned char* data) = 0;
  virtual unsigned int ReadDataFromDSU(unsigned int start_address, unsigned int nofbytes, unsigned char* data) = 0;
  virtual unsigned int SetupDSUAcquisition(unsigned int start_address, unsigned int end_address) = 0;
  virtual unsigned int StartDSUAcquisition() = 0;
  virtual unsigned int GetNextDSURecordingAddress(unsigned int* next_address) = 0;
...
extern "C"
{
    ...
    DLL_IMPORT unsigned int ADQControlUnit_EnableErrorTrace(void* adq_cu_ptr, int trace_level, const char* trace_file_dir);
    DLL_IMPORT unsigned int ADQControlUnit_EnableErrorTraceAppend(void* adq_cu_ptr, int trace_level, const char* trace_file_dir);
...
extern "C" {
  ...
  DLL_IMPORT  unsigned int ADQ_ReBootADQFromFlash(void* adq_cu_ptr, int adq_num);
  ...
  DLL_IMPORT  unsigned int ADQ_TriggeredStreamingSetupV5(void* adq_cu_ptr, int adq_num , unsigned int SamplePerRecord, unsigned int NofPreTrigSamples, unsigned int NofHoldOffSamples, unsigned int ArmMode, unsigned int ReadOutSpeed, unsigned int Channel);
  ...
  DLL_IMPORT  unsigned int ADQ_ResetRecorder(void* adq_cu_ptr, int adq_num);
  DLL_IMPORT  unsigned int ADQ_ResetFIFOPaths(void* adq_cu_ptr, int adq_num);
  DLL_IMPORT  unsigned int ADQ_RunRecorderSelfTest(void* adq_cu_ptr, int adq_num , unsigned int* inout_vector);
  DLL_IMPORT  unsigned int ADQ_GetRecorderStatus(void* adq_cu_ptr, int adq_num , unsigned int* status);
  DLL_IMPORT  unsigned int ADQ_GetRecorderDiskStatus(void* adq_cu_ptr, int adq_num , unsigned int diskno, unsigned int* status);
  DLL_IMPORT  unsigned int ADQ_BreakRecorderCommand(void* adq_cu_ptr, int adq_num);
  DLL_IMPORT  unsigned int ADQ_SendRecorderCommand(void* adq_cu_ptr, int adq_num , unsigned char cmd, unsigned int arg1, unsigned int arg2, unsigned int* answer);
  DLL_IMPORT  unsigned int ADQ_WriteDataToDSU(void* adq_cu_ptr, int adq_num , unsigned int start_address, unsigned int nofbytes, unsigned char* data);
  DLL_IMPORT  unsigned int ADQ_ReadDataFromDSU(void* adq_cu_ptr, int adq_num , unsigned int start_address, unsigned int nofbytes, unsigned char* data);
  DLL_IMPORT  unsigned int ADQ_SetupDSUAcquisition(void* adq_cu_ptr, int adq_num , unsigned int start_address, unsigned int end_address);
  DLL_IMPORT  unsigned int ADQ_StartDSUAcquisition(void* adq_cu_ptr, int adq_num);
  DLL_IMPORT  unsigned int ADQ_GetNextDSURecordingAddress(void* adq_cu_ptr, int adq_num , unsigned int* next_address);
...
extern "C" {
  ...
  DLL_IMPORT unsigned int        DSU_WriteDataToDSU(void* adq_cu_ptr, int DSU_num, unsigned int start_address, unsigned int nofbytes, unsigned char* data);
  DLL_IMPORT unsigned int        DSU_ReadDataFromDSU(void* adq_cu_ptr, int DSU_num, unsigned int start_address, unsigned int nofbytes, unsigned char* data);
  DLL_IMPORT unsigned int        DSU_StartDSUAcquisition(void* adq_cu_ptr, int DSU_num);
  DLL_IMPORT unsigned int        DSU_SetupDSUAcquisition(void* adq_cu_ptr, int DSU_num, unsigned int start_address, unsigned int end_address);
  DLL_IMPORT unsigned int        DSU_ResetRecorder(void* adq_cu_ptr, int DSU_num);
  DLL_IMPORT unsigned int        DSU_ResetFIFOPaths(void* adq_cu_ptr, int DSU_num);
  DLL_IMPORT unsigned int        DSU_RunRecorderSelfTest(void* adq_cu_ptr, int DSU_num, unsigned int* inout_vector);
...
extern "C" {
  ...
  DLL_IMPORT unsigned int        SDR14_ReBootADQFromFlash(void* adq_cu_ptr, int sdr14_num);
...
extern "C"
{
  ...
  DLL_IMPORT unsigned int     ADQ1600_ReBootADQFromFlash(void* adq_cu_ptr, int ADQ1600_num);
...
extern "C" {
  ...
  DLL_IMPORT unsigned int    ADQ412_ReBootADQFromFlash(void* adq_cu_ptr, int ADQ412_num);
...
extern "C" {
  ...
  DLL_IMPORT unsigned int        ADQ214_TriggeredStreamingSetupV5(void* adq_cu_ptr, int ADQ214_num, unsigned int SamplePerRecord, unsigned int NofPreTrigSamples, unsigned int NofHoldOffSamples, unsigned int ArmMode, unsigned int ReadOutSpeed, unsigned int Channel);
