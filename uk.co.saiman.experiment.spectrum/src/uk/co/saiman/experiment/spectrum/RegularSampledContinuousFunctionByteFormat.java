...
public class RegularSampledContinuousFunctionByteFormat<UD extends Quantity<UD>, UR extends Quantity<UR>>
  ...
  protected RegularSampledContinuousFunctionByteFormat(
  ...
  public static <UD extends Quantity<UD>, UR extends Quantity<UR>> ByteFormat<SampledContinuousFunction<UD, UR>> overEncodedDomain(
    ...
    return new ByteFormat<SampledContinuousFunction<UD, UR>>() {
      ...
      @Override
      public SampledContinuousFunction<UD, UR> load(ReadableByteChannel inputChannel)
          throws IOException {
        RegularSampledDomain<UD> domain = new RegularSampledDomainByteFormat<>(domainUnit)
            .load(inputChannel);
        return overDomain(domain, rangeUnit).load(inputChannel);
      }

      @Override
      public void save(WritableByteChannel outputChannel, SampledContinuousFunction<UD, UR> data)
          throws IOException {
