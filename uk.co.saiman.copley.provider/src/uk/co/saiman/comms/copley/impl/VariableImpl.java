...
class VariableImpl<U> implements Variable<U> {
  ...
  public U get() {
    try {
      ...
      throw new CopleyVariableException(format("Failed to get variable %s", id), e);
    }
  }
  ...
  public void set(U output) {
    try {
      ...
      throw new CopleyVariableException(format("Failed to set variable %s", id), e);
    }
  }
  ...
  public void copyToBank() {
    try {
      ...
      throw new CopleyVariableException(format("Failed to copy variable %s to bank", id), e);
    }
  }
