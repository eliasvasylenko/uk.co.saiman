...
import static uk.co.saiman.reflection.TypeVariables.unboundedTypeVariable;
...
import static uk.co.saiman.reflection.matchers.IsAssignableTo.isAssignableTo;
import static uk.co.saiman.reflection.matchers.IsStrictlyAssignableTo.isStrictlyAssignableTo;
import static uk.co.saiman.reflection.matchers.IsSubtypeOf.isSubtypeOf;
...
public class AssignmentTest {
  ...
  public void classWithParameterizedSuperclassToParameterizedAssignment() {
    assertThat(
        StringComparable.class,
        isAssignableTo(parameterize(Comparable.class, String.class)));
    assertThat(
        StringComparable.class,
        not(isAssignableTo(parameterize(Comparable.class, Number.class))));
  }
  ...
  public void primitiveArrayToBoxedArrayAssignment() {
    assertThat(
        arrayFromComponent(int.class),
        not(isAssignableTo(arrayFromComponent(Integer.class))));
  }

  @Test
  public void boxedArrayToPrimitiveArrayAssignment() {
    assertThat(
        arrayFromComponent(Integer.class),
        not(isAssignableTo(arrayFromComponent(int.class))));
  }
  ...
  public void classToLowerBoundedWildcardAssignment() {
    ...
    assertThat(
        Integer.class,
        isAssignableTo(wildcardSuper(parameterize(Comparable.class, Integer.class))));
  }
  ...
  public void upperBoundedWildcardToParameterizedAssignment() {
    assertThat(
        wildcardExtending(Integer.class),
  ...
  public void genericArrayToClassAssignment() {
    assertThat(
        arrayFromComponent(parameterize(Comparable.class, String.class)),
        not(isAssignableTo(Comparable.class)));
  ...
  public void genericArrayToGenericArrayAssignment() {
    assertThat(
        ...
        isAssignableTo(
            arrayFromComponent(parameterize(Comparable.class, wildcardSuper(Integer.class)))));
  ...
  public void parameterizedToParameterizedContainment() {
    ...
    assertThat(
        ...
        not(
            isAssignableTo(
                parameterize(
                    Set.class,
                    wildcardExtending(parameterize(Set.class, Object.class))))));
    ...
    assertThat(
        ...
        isAssignableTo(
            parameterize(
                Set.class,
                wildcardExtending(parameterize(Set.class, wildcardSuper(Integer.class))))));
  }
