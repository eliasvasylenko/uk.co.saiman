...
public class TypeVariables {
  ...
  public static <T extends GenericDeclaration> TypeVariable<T> unboundedTypeVariable(
      T declaration,
      String name) {
    return new TypeVariable<T>() {
      ...
      @Override
      public int hashCode() {
        return Arrays.hashCode(getBounds()) ^ Objects.hashCode(getName())
            ^ Objects.hashCode(getGenericDeclaration());
      }
