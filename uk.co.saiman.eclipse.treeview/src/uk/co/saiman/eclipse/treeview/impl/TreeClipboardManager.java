...
import uk.co.saiman.eclipse.treeview.impl.TreeEntryClipboardImpl.DragHandler;
import uk.co.saiman.eclipse.treeview.impl.TreeEntryClipboardImpl.DropHandler;
...
public class TreeClipboardManager {
  ...
  public <T> TreeEntryClipboardImpl<T> getForType(TypeToken<T> type) {
    return new TreeEntryClipboardImpl<>(type, dragHandlers::add, dropHandlers::add);
  }
}
