...
public final class TreeEntryEditorImpl implements TreeEntryEditor {
  private final boolean editing;
  private boolean editable;

  public TreeEntryEditorImpl(boolean editing) {
  ...
  @Override
  public TreeEntryEditor setEditable(boolean editable) {
