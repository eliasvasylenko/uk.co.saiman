...
@ObjectClassDefinition(name = "Console Log Configuration", description = "The console log provides a listener over the OSGi log service which directs output to stdout")
