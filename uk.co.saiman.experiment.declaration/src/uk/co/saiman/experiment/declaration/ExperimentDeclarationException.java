...
public class ExperimentDeclarationException extends RuntimeException {
  private static final long serialVersionUID = 1L;

  public ExperimentDeclarationException(String message) {
    super(message);
  }

  public ExperimentDeclarationException(String message, Throwable cause) {
    super(message, cause);
  }
}
